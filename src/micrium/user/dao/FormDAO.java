...
public class FormDAO implements Serializable {
	...
	public List<MuFormulario> getListMod() {
		return entityManager.createQuery("SELECT us FROM MuFormulario us where us.formularioId is null ORDER BY us.formularioId, us.orden").getResultList();
	}
	
	@SuppressWarnings("unchecked")
	public List<MuFormulario> getListPage() {
		return entityManager.createQuery("SELECT us FROM MuFormulario us where us.formularioId is not null ORDER BY us.formularioId, us.orden").getResultList();
	}
	
	@SuppressWarnings("unchecked")
	public List<MuFormulario> getListPage(long idModForm) {
		return entityManager.createQuery("SELECT us FROM MuFormulario us where us.formularioId = :idModForm ORDER BY us.formularioId, us.orden").setParameter("idModForm", idModForm).getResultList();
	}
