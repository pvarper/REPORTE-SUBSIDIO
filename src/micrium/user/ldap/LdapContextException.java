...
/**
 * Esta Clase tiene como finalidad principal identificar y personalizar los tipos de error
 * que suceden cuando se realiza la conexion al  servidor LDAP
 * @author: Cesar Augusto Choque S
 * @version: 20-04-2015
 * 
 * **/
public class LdapContextException extends Exception{
