...
/**
 *Esta Clase se encarga de controlar  o gestionar los privilegios que tiene el usuario al momneto de 
 *ingresar al sistema, siendo de tipo session para que sea usada en cualquier bean que requiera trabajar con permisos.
...
public class ControlPrivilegio implements Serializable{
	...
	/**
	 * Este metodo es usado para cargar los permisos que se usaran en toda la session del usuario.
	...
	/**
	 * Este metodo indica si un usuario tiene un determinado permiso para realizar una accion en un formulario especifico.
	 * @param idForm identifica al formulario que se decea evaluar.
	 * @param idAccion Identifica la  accion que se esta consultando.
	 * @return retorna si el usuario esta autorizado para realizar dicha accion 
	 * valores posibles: [true= esta autorizado, false = no esta autorizado].
	 * @see micrium.id.FormularioID
	 * @see micrium.id.PrivilegioID
	 * **/
	...
	/**
	 * Este metodo debe ser utilizado para obtener la instancia del Bean de la clase ControlPrivilegio, es recomendable utilizar
	 * este metodo en el metodo init() del bean donde se  esta  injectando.
	 * **/
