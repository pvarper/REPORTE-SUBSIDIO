...
/**
 * Esta Clase tiene como objetivo unico el de proporcionar todas las acciones disponibles 
 * en el sistema y puedan ser consultadas desde las diferentes vistas xhtml.
...
public class PrivilegioID implements Serializable{
	...
	/**
	 * En caso de ser necesario es posible   que se creen mas acciones, dependiendo de las 
	 * necesidades del proyecto, por lo cual debera incluirse las nuevas acciones aqui, manteniendo
